...
public class Recensione {
     ...
     * @param risposta La riposta del ristoratore
     */
     ...
     * @return {@code true} se la recensione ha una risposta, {@code false} altrimenti
     */
     ...
     * @throws RecensioneException Se i dati inseriti non sono valorizzati nel modo corretto.
     */
    private void validaAttributi(Cliente cliente, Ristorante ristorante, int stelle) {
        ...
        if (cliente == null) {
            String messaggio = "Il cliente deve essere valorizzato correttamente.\n";
            errori.append(messaggio);
            errore = true;
        }
        if (ristorante == null) {
            String messaggio = "Il ristorante deve essere valorizzato correttamente.\n";
            errori.append(messaggio);
            errore = true;
        }
        if (stelle < 1 || stelle > 5) {
            String messaggio = "Le stelle devono avere un valore compreso tra 1 e 5.";
            errori.append(messaggio);
            errore = true;
        }
    ...
    public static void main(String[] args) {
        ...
        Ristorante ristorante1 = new Ristorante("La Tavola", "Italia", "Milano",
                "Via Roma 123", 45.4642f, 9.1900f,
